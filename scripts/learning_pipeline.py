...
def main():
    ...
    for s in range(10):  # number of splits 5 * 10
        ...
        klc = model_selection.MultipleKernelGridSearchCV(
                ...
                param_grid={'lamda': [0.1, 0.4, 0.9], 'beta': [0.1, 0.4, 0.9],'l1_ratio_beta': [0.1, 0.4, 0.9],'l1_ratio_lamda': [0.1, 0.4, 0.9]},
        ...
        pickle.dump(cv_results, open("/home/compbio/networkEEG/experiments_04/split_"+str(s)+".pkl", "wb"))
