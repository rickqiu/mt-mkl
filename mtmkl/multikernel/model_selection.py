...
def cross_validate(
    ...
    generate_index_iter = generate_index(X, y, cv)
        ...
        out = Parallel(
            ...
            pre_dispatch=pre_dispatch)(
                delayed(_fit_and_score)(
                    ...
                    self.verbose, parameters, fit_params=fit_params,
...
class MultipleKernelRandomizedSearchCV(RandomizedSearchCV,
    ...
    def fit(self, X, y=None, groups=None, **fit_params):
        ...
        **fit_params : dict of string -> object
        ...
        """
        return MultipleKernelGridSearchCV.fit(
            self, X=X, y=y, groups=groups, **fit_params)
